...
{
    fileName = map_name;
    loadSearchGraph(searchGraph, vNameToID, vNameToV, vNameToDirection, vIDToConflictPoints, fileName, pairDistances, pairDistancesMap, "/media/zijun/Data/Documents/2020Summer/AIM/PBS/pairDistance2.json");
    std::cout << "Instance: graph loaded\n";
    loadVehicles("/media/zijun/Data/Documents/2020Summer/AIM/PBS/vehicleArrival.json", 0, agents, vNameToID);
