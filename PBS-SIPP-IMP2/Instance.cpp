...
{
    string arrFile = "/media/zijun/Data/Documents/2020Summer/AIM/PBS-IMP2/vehicleArrival.json";
    string PDFile = "/media/zijun/Data/Documents/2020Summer/AIM/PBS-IMP2/pairDistance2.json";
    int step = 35;
    fileName = map_name;
